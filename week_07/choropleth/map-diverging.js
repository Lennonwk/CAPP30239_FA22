...
Promise.all([
  ...
  const color = d3.scaleQuantize()
    ...
    // .range(d3.schemePuOr[9]); // Alternative color scheme https://observablehq.com/@d3/color-schemes // could substitute this line for thee line above
    ...
    .appendChild(
      Legend(
        d3.scaleOrdinal(
          ...
          // (d3.schemePuOr[9]) // Alternative color scheme https://observablehq.com/@d3/color-schemes // could substitute this line for the line above in place of manually defining the range. 
        ),
